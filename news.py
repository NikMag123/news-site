...
KEYWORDS = [
    "недвижимость", "жилье", "жилищ", "аренда", "ипотека",
    "земельный", "земля", "купля-продажа", "регистрация прав",
    "кадастр", "собственность", "квартира", "дом", "строительство",
    "застройка", "цемент", "жилой"
]
